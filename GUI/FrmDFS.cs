...
namespace MoPhongDoThi.GUI
{
    public partial class FrmDFS : Form
    {
        ...
        {
            int i = 1;
            dgvDsDinh.DataSource = Data.Data.graph_DFS.dsDinh
                                   .Select(p => new
                                   {
                                        ID = p.ID,
                                        STT = i++,
        ...
        {
            int i = 1;
            dgvDsCanh.DataSource = Data.Data.graph_DFS.dsCanh.ToList()
                                   .Select(p => new
                                   {
                                       ID = p.ID,
                                       STT = i++,
                                       Dinh1 = Data.Data.graph_DFS.dsDinh.Where(z=>z.ID == p.IDXP).FirstOrDefault().Ten,
                                       Dinh2 = Data.Data.graph_DFS.dsDinh.Where(z => z.ID == p.IDKT).FirstOrDefault().Ten,
                                       TrongSo = p.TrongSo,
        ...
        private void HienThiDoThi()
        {
            ...
            FrmVeDoThi vedothi = new FrmVeDoThi(Data.Data.graph_DFS);
        ...
        {
            FrmDFSThemDinh form = new FrmDFSThemDinh();
            form.ShowDialog();
            Loadz();
        }
        ...
        private void btnXoaDinh_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Data.Data.graph_DFS.dsDinh.RemoveAll(p => p.ID == id);
                Data.Data.graph_DFS.dsCanh.RemoveAll(p => p.IDXP == id || p.IDKT == id);
        ...
        {
            FrmDFSThemCanh form = new FrmDFSThemCanh();
            form.ShowDialog();
            Loadz();
        }
        ...
        {
            FrmDFSDieuKhienChay form = new FrmDFSDieuKhienChay();
            form.ShowDialog();
        }

        private void btnXoaCanh_Click(object sender, EventArgs e)
        {
            if (Data.Data.graph_DFS.dsDinh.Count == 0)
            {
            ...
            try
            {
                ...
                Data.Data.graph_DFS.dsCanh.RemoveAll(p => p.ID == id);
        ...
        private void ThemDinhTaiViTri_Click(object sender, EventArgs e)
        {
            ...
            FrmDFSThemDinh form = new FrmDFSThemDinh(tdx, tdy);
            form.ShowDialog();
            Loadz();
        }
        ...
        private void XoaTatCaCacDinh_Click(object sender, EventArgs e)
        {
            ...
            if (rs == DialogResult.Cancel) return;
            Data.Data.graph_DFS.dsDinh.Clear();
            Data.Data.graph_DFS.dsCanh.Clear();
            Loadz();
        }
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            if (file.ShowDialog() == DialogResult.OK)
            {
                ...
                Data.Data.graph_DFS.ReadFile(FileName);
                foreach (Canh canh in Data.Data.graph_DFS.dsCanh) canh.TrongSo = -1;
                Loadz();
            }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                string FileName = file.FileName;
                Data.Data.graph_DFS.WriteFile(FileName);
                Loadz();
            }
        }
        #endregion
